...
export const CookieBannerView = () => {
    ...
    text.innerText = 'We use cookies to statistics and marketing purposes. You can choose necessary cookies only or accept all cookies.';

    const btns = Div('CookieBanner__btns');
    const acceptAll = Button('Accept All Cookies', 'button', 'btn btn--primary CookieBanner__btn');
    acceptAll.id = 'acceptAllCookiesBtn';
    const acceptNecessary = Button('Accept Necessary Cookies Only', 'button', 'btn btn--secondary CookieBanner__btn');
